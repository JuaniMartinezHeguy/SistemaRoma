      ...
      <div className="max-w-7xl mx-auto pt-32 px-6">
        ...
        {propiedadesDestacadas.length > 0 && (
          <div className="mb-32 animate-in fade-in duration-1000 delay-100 relative">
            ...
            <div className="flex items-center justify-center gap-3 mb-10">
              <Medal size={32} className="text-[#00d15b]" weight="regular" />
            ...
            <div className="relative w-full max-w-6xl mx-auto h-[500px] md:h-[450px] flex items-center justify-center">
              ...
              {propiedadesDestacadas.length > 1 && (
                <button 
                  ...
                  className="absolute left-0 md:-left-6 z-20 w-12 h-12 flex items-center justify-center bg-[#1a1a1a] hover:bg-[#00d15b] text-white hover:text-black rounded-full border border-white/10 transition-all duration-300 shadow-xl"
                >
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/2 h-[50%] md:h-full relative overflow-hidden">
                      ...
                      <div className="absolute top-6 left-6">
                        <span className="bg-[#00d15b] text-black text-[10px] font-black uppercase px-3 py-1.5 rounded-lg tracking-widest shadow-md">
                          {prop.operacion}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 h-[50%] md:h-full p-8 md:p-12 flex flex-col justify-center relative bg-[#161616]">
                      ...
                      <button 
                        ...
                        className="mt-auto w-full md:w-fit px-10 py-4 bg-[#00d15b] hover:bg-[#14b854] text-black rounded-xl font-black uppercase tracking-[0.2em] text-xs transition-all hover:scale-[1.02] shadow-lg shadow-green-900/20"
                      >
                        Ver Detalles
                      </button>
                    </div>
              ...
              {propiedadesDestacadas.length > 1 && (
                <button 
                  ...
                  className="absolute right-0 md:-right-6 z-20 w-12 h-12 flex items-center justify-center bg-[#1a1a1a] hover:bg-[#00d15b] text-white hover:text-black rounded-full border border-white/10 transition-all duration-300 shadow-xl"
                >
              ...
              <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 flex gap-3">
                {propiedadesDestacadas.map((_, idx) => (
                  <button
                    ...
                    className={`h-1.5 rounded-full transition-all duration-500 ${idx === destacadaIndex ? 'w-10 bg-[#00d15b]' : 'w-4 bg-gray-600 hover:bg-gray-400'}`}
                  />
                ))}s
              </div>
            )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button onClick={() => toggleDropdown('tipo')} className="flex items-center gap-2 bg-[#1f1f1f] hover:bg-[#2a2a2a] border border-white/5 text-white px-4 py-2.5 rounded-2xl font-bold transition-colors text-xs uppercase tracking-wider">
                <HouseLine size={16} className="text-[#00d15b]" /> Tipo <CaretDown size={14} />
              </button>
              {dropdownAbierto === 'tipo' && (
                <div className="absolute top-full left-0 mt-3 w-48 bg-[#1f1f1f] border border-white/10 shadow-2xl rounded-2xl p-2 flex flex-col gap-1 z-50">
                  {tipos.map(t => (
                    <button key={t} onClick={() => { setFiltroTipo(t); setDropdownAbierto(null); }} className="text-left px-4 py-2 rounded-xl hover:bg-[#00d15b] hover:text-black text-white font-bold text-xs transition-colors">{t}</button>
                  ))}
                </div>
              )}
            </div>
            ...
            <div className="relative">
              <button onClick={() => toggleDropdown('ubicacion')} className="flex items-center gap-2 bg-[#1f1f1f] hover:bg-[#2a2a2a] border border-white/5 text-white px-4 py-2.5 rounded-2xl font-bold transition-colors text-xs uppercase tracking-wider">
                <MapTrifold size={16} className="text-[#00d15b]" /> Zona <CaretDown size={14} />
              </button>
              {dropdownAbierto === 'ubicacion' && (
                <div className="absolute top-full left-0 mt-3 w-56 bg-[#1f1f1f] border border-white/10 shadow-2xl rounded-2xl p-2 flex flex-col gap-1 z-50">
                  {ubicaciones.map(u => (
                    <button key={u} onClick={() => { setFiltroUbicacion(u); setDropdownAbierto(null); }} className="text-left px-4 py-2 rounded-xl hover:bg-[#00d15b] hover:text-black text-white font-bold text-xs transition-colors">{u}</button>
                  ))}
                </div>
              )}
            </div>
            ...
            <div className="relative hidden sm:block">
              <button onClick={() => toggleDropdown('operacion')} className="flex items-center gap-2 bg-[#1f1f1f] hover:bg-[#2a2a2a] border border-white/5 text-white px-4 py-2.5 rounded-2xl font-bold transition-colors text-xs uppercase tracking-wider">
                <Tag size={16} className="text-[#00d15b]" /> Operación <CaretDown size={14} />
              </button>
              {dropdownAbierto === 'operacion' && (
                <div className="absolute top-full left-0 mt-3 w-48 bg-[#1f1f1f] border border-white/10 shadow-2xl rounded-2xl p-2 flex flex-col gap-1 z-50">
                  {operaciones.map(o => (
                    <button key={o} onClick={() => { setFiltroOperacion(o); setDropdownAbierto(null); }} className="text-left px-4 py-2 rounded-xl hover:bg-[#00d15b] hover:text-black text-white font-bold text-xs transition-colors">{o}</button>
                  ))}
                </div>
              )}
            </div>
        ...
        {(filtroTipo !== 'Todos' || filtroUbicacion !== 'Todas' || filtroOperacion !== 'Todas') && (
          <div className="flex flex-wrap items-center gap-3 mb-10 -mt-4 pl-4 animate-in fade-in slide-in-from-top-4">
            {filtroTipo !== 'Todos' && (
              <div className="flex items-center gap-2 bg-[#00d15b] text-black px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-md"><HouseLine size={12}/> {filtroTipo} <button onClick={() => setFiltroTipo('Todos')} className="hover:scale-125 transition-transform"><X size={12} weight="bold" /></button></div>
            )}
            {filtroUbicacion !== 'Todas' && (
              <div className="flex items-center gap-2 bg-[#00d15b] text-black px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-md"><MapTrifold size={12}/> {filtroUbicacion} <button onClick={() => setFiltroUbicacion('Todas')} className="hover:scale-125 transition-transform"><X size={12} weight="bold" /></button></div>
            )}
            {filtroOperacion !== 'Todas' && (
              <div className="flex items-center gap-2 bg-[#00d15b] text-black px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-md"><Tag size={12}/> {filtroOperacion} <button onClick={() => setFiltroOperacion('Todas')} className="hover:scale-125 transition-transform"><X size={12} weight="bold" /></button></div>
            )}
            <button onClick={() => {setFiltroTipo('Todos'); setFiltroUbicacion('Todas'); setFiltroOperacion('Todas');}} className="text-gray-500 hover:text-[#00d15b] text-[10px] font-bold uppercase tracking-widest ml-2 transition-colors underline underline-offset-4">Limpiar todo</button>
          </div>
        )}
        ...
        {/* =========================================================
            ...
            ========================================================= */}
        <h2 className="text-2xl font-black text-white mb-8 border-l-4 border-[#00d15b] pl-4 uppercase tracking-widest">Catálogo Completo</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
          {propiedades.length > 0 ? propiedades.map((item) => (
            ...
            <div 
              ...
              className="group bg-[#1a1a1a] rounded-[24px] overflow-hidden border border-[#2a2a2a] shadow-xl hover:-translate-y-1 hover:shadow-2xl hover:border-[#00d15b] transition-all duration-300 flex flex-col cursor-pointer"
            >
              <div className="relative h-56 w-full overflow-hidden bg-black">
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  <span className="bg-[#00d15b] text-black text-[10px] font-black uppercase px-3 py-1 rounded-lg tracking-widest shadow-md">{item.operacion}</span>
              ...
              <div className="p-6 pt-4 flex-1 flex flex-col relative text-white">
                <a 
                  ...
                  className="absolute -top-8 right-6 h-14 w-14 bg-[#00d15b] hover:bg-white text-black rounded-full flex items-center justify-center shadow-[0_4px_14px_rgba(0,209,91,0.4)] transition-all hover:scale-110 z-10"
                >
                  <WhatsappLogo size={28} weight="fill" />
                </a>

                <div className="mb-3 pr-12">
                  <span className="text-[#00d15b] text-[10px] font-bold uppercase tracking-widest mb-1.5 block">{item.tipo_propiedad}</span>
                ...
                <div className="flex items-center gap-1.5 text-gray-400 text-sm mt-auto mb-4">
                  <MapPin size={16} className="text-[#00d15b]" /> {item.ubicacion}
                </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-8 animate-in fade-in duration-300">
          ...
          <div className="relative w-full max-w-5xl bg-[#161616] border border-white/10 rounded-[40px] overflow-hidden shadow-2xl flex flex-col md:flex-row max-h-[90vh] animate-in zoom-in-95 duration-300">
              ...
              <div className="flex-1 w-full relative rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.8)]">
                ...
                {imagenesCarrusel.length > 1 && (
                  <div className="absolute bottom-6 left-0 right-0 flex justify-center gap-4 px-10">
                    <button onClick={prevImagen} className="bg-black/50 hover:bg-[#00d15b] text-white hover:text-black p-3 rounded-full backdrop-blur-md transition-all"><CaretLeft size={20} weight="bold" /></button>
                    <button onClick={nextImagen} className="bg-black/50 hover:bg-[#00d15b] text-white hover:text-black p-3 rounded-full backdrop-blur-md transition-all"><CaretRight size={20} weight="bold" /></button>
                  </div>
                )}
              </div>
            ...
            <div className="w-full md:w-1/2 flex flex-col overflow-y-auto custom-scrollbar bg-[#161616] p-10 relative">
              <span className="text-[#00d15b] text-[10px] font-black uppercase tracking-[0.3em] mb-3 block">{propiedadActiva.tipo_propiedad}</span>
              <h2 className="text-3xl md:text-4xl font-black text-white leading-tight mb-4 pr-12">{propiedadActiva.titulo}</h2>
              <div className="flex items-center gap-2 text-gray-500 text-xs font-black uppercase tracking-widest mb-8"><MapPin size={18} className="text-[#00d15b]" /> {propiedadActiva.ubicacion}</div>
              ...
              {propiedadActiva.dimensiones && (
                <div className="bg-[#222222] border border-white/5 px-5 py-3 rounded-2xl flex items-center gap-4 w-fit mb-8">
                  <div className="bg-[#00d15b]/15 p-3 rounded-xl text-[#00d15b]"><Ruler size={22} weight="bold" /></div>
                  <div>
              ...
              <div className="mb-10 flex-1">
                <h3 className="text-white text-xs font-black uppercase tracking-[0.2em] flex items-center gap-2 mb-6 border-b border-white/5 pb-4"><Info size={18} className="text-[#00d15b]" /> Descripción</h3>
              ...
              <a 
                ...
                target="_blank" rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-3 bg-[#00d15b] hover:bg-[#14b854] text-black px-8 py-4 rounded-xl font-black transition-all hover:scale-[1.02] uppercase tracking-widest text-sm mt-auto"
              >
