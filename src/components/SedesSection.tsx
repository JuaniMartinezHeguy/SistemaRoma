...
export default function SedesSection() {
  ...
  // Coordenadas ampliadas y verticalmente estiradas (Lienzo de 680x780)
  ...
  return (
    <section id="ubicaciones" className="relative z-10 pt-28 pb-40 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* 2. BARRA DINÁMICA DE TRAYECTORIA (REEMPLAZA A LOS NÚMEROS PESADOS) */}
        <motion.div
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-white/10 pb-5 mb-8">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-widest text-roma-leaf bg-black/40 px-3.5 py-1.5 rounded-full border border-roma-leaf/30 hidden sm:inline-block">
              Liderazgo Inmobiliario Rural
            </span>
          </div>

          {/* Línea de Trayectoria Dinámica con Nodos Interactivos */}
          <div className="relative pt-4 pb-2">

            {/* Traza de fondo (de centro de punto 0 [12.5%] a centro de punto 3 [87.5%]) */}
            <div className="absolute top-[30px] left-[12.5%] right-[12.5%] h-[3px] bg-white/10 rounded-full pointer-events-none" />

            {/* Progreso fluido animado (va exactamente de punto en punto sin sobrepasarse) */}
            <motion.div
            ...
            {/* Detalle Dinámico Fluido del Hito Seleccionado */}
        ...
        {/* 3. ESTRUCTURA EN 2 COLUMNAS (SEDES A LA IZQUIERDA Y MAPA TRADICIONAL A LA DERECHA) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-start">

          {/* COLUMNA IZQUIERDA: TARJETAS DE SEDES FÍSICAS Y CHIPS DE LOCALIDADES */}
          <div className="lg:col-span-6 flex flex-col gap-8 text-left">

            {/* Lista de Sedes Físicas (3 Tarjetas) */}
            <div>
            ...
            {/* Bloque de Cobertura Geográfica Corregido (chips interactivos) */}
          ...
          {/* COLUMNA DERECHA: MAPA TRADICIONAL CON CURSO REAL DEL RÍO NEGRO Y DESEMBOCADURA */}
            ...
            <div className="bg-[#1a2c1a]/95 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col gap-6">
              ...
              <div className="relative w-full h-[650px] bg-[#f4efe0] rounded-3xl overflow-hidden border border-white/20 p-2 shadow-2xl group">
                ...
                >
                  ...
                  {/* CURSO REAL Y MEANDROS DEL RÍO NEGRO HASTA SU DESEMBOCADURA EN EL MAR */}
                  {/* Estuario / Boca de Mar en El Cóndor (Desembocadura) */}
                  <path
                  ...
                  {/* Cauce Principal del Río Negro con Meandros Naturales */}
                  <path
                  ...
                  {/* LOCALIDADES SOLO LETRA CON CONTORNO BLANCO CARTOGRÁFICO Y POSICIONAMIENTO PERFECTO */}
                  {allItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        {/* Anillo Pulsante al Seleccionar */}
                        {isSelected && (
                          <circle
                            r={isSede ? 14 : 11}
                            fill="none"
                        ...
                        {/* Texto Cartográfico con Contorno Blanco anti-solapamiento (paintOrder=stroke fill) */}
                        <text
                          x={dx}
                          y={dy}
                          fill="#0f172a"
              ...
              {/* Pie de Foto / Caption Dinámico (Inferior Derecha) */}
